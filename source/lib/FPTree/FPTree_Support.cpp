...
namespace NguyenQuocHuy {
    ...
    FPTreeOperationContainer* FPTreeOperationContainer::unblockConditionalFPTree(int itemID) {
        ...
        FPTreeOperationContainer* result = new FPTreeOperationContainer(this->nItems, itemList);
